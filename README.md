...
> **⚠️ macOS 安裝注意（應用程式已損毀錯誤）：**
> 如果在 Mac 上開啟時遇到「已損毀」錯誤，請下載並點擊執行 [解鎖TypeK.command](https://raw.githubusercontent.com/kekukeku/TypeK/main/%E8%A7%A3%E9%8E%96TypeK.command) 腳本以自動解除隔離限制，或開啟終端機執行：`sudo xattr -cr /Applications/TypeK.app`。
