...
> **⚠️ macOS 安装注意（应用程序已损坏错误）：**
> 如果在 Mac 上打开时遇到“已损坏”错误，请下载并点击运行 [解锁TypeK.command](https://raw.githubusercontent.com/kekukeku/TypeK/main/%E8%A7%A3%E9%8E%96TypeK.command) 脚本以自动解除隔离限制，或打开终端执行：`sudo xattr -cr /Applications/TypeK.app`。
